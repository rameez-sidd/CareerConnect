...
const LatestJobCards = ({job}) => {
  ...
  return (
    <div onClick={()=>navigate(`/jobs/description/${job._id}`)} className='flex flex-col gap-3 shadow-xl py-6 px-3 rounded-md cursor-pointer border border-gray-300 bg-white'>
        <div>
