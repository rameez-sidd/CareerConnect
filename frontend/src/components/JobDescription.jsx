          ...
          <div className="flex flex-col gap-10">
            <div className="flex items-center justify-between">
              <div className="flex flex-col gap-3">
                ...
                <div className="flex items-center gap-2">
                  <Badge variant="ghost" className="text-sky-700">
                    {singleJob?.position} Positions
                  </Badge>
                  <Badge variant="ghost" className="text-rose-700">
                    {singleJob?.jobType}
                  </Badge>
                  <Badge variant="ghost" className="text-fuchsia-800">
              ...
              <div className="hidden sm:block">
                {!isApplied ? (
                  ...
                  <Button className="cursor-not-allowed bg-gray-400 hover:bg-gray-400">
                    Already Applied
                  </Button>
                )}
              </div>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="font-semibold">
                  Role :{" "}
                  <span className="font-normal ml-2">{singleJob?.title}</span>
                </div>
                <div className="font-semibold">
                  Location :{" "}
                  <span className="font-normal ml-2">
            ...
            <div className="sm:hidden">
              {!isApplied ? (
                <Button
                  className="bg-sky-700 hover:bg-sky-900 w-full"
                  onClick={applyJob}
                >
                  Apply
                </Button>
              ) : (
                <Button className="cursor-not-allowed bg-gray-400 hover:bg-gray-400 w-full">
                  Already Applied
                </Button>
              )}
            </div>
