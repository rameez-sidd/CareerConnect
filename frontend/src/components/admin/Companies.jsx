...
const Companies = () => {
  ...
  return (
    <div>
        <Navbar/>
        <div className='max-w-5xl mx-auto my-12 flex flex-col gap-10 px-5 lg:px-0 '>
            <div className='flex items-center justify-between'>
                <Input placeholder="Filter by name" className="w-fit bg-white" onChange={(e)=>setInput(e.target.value)}/>
