...
const Profile = () => {
  ...
  return (
    ...
    <>
      <Navbar />
       <div className="max-w-4xl mx-auto my-12 px-5 lg:px-0">

       
        <div className="bg-white flex flex-col gap-6 rounded-md border border-gray-300 shadow-md p-8 ">
          <div className="flex items-center justify-between">
            ...
            <Button
              variant="outline"
              className="rounded-full px-6 py-6 ml-3 self-start"
              size="icon"
        ...
        <div className="bg-white flex flex-col gap-4 rounded-md border border-gray-300 shadow-md p-8 max-w-4xl mx-auto mt-4">
