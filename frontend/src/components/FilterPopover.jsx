...
const FilterPopover = () => {
  ...
  return (
    <div className="flex items-center justify-between w-full">
      <Popover>
        <PopoverTrigger>
          <div className="bg-black text-white hover:bg-gray-800 focus:ring-2 focus:ring-black rounded-md px-4 py-2 text-sm font-medium transition-colors">Filter</div>
        </PopoverTrigger>
